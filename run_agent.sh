...
echo "    snmpget -v 2c -c public -M+. localhost:5555 .1.3.6.1.4.1.53864.1"
echo ""
echo "    snmpget -v 2c -c public -M+. localhost:5555 AFINITI-TEST-MIB::latestSignal"
echo "    snmpget -v 2c -c public -M+. localhost:5555 .1.3.6.1.4.1.53864.2"
echo ""
echo "    snmpget -v 2c -c public -M+. localhost:5555 AFINITI-TEST-MIB::diskSpace"
echo "    snmpget -v 2c -c public -M+. localhost:5555 .1.3.6.1.4.1.53864.3"
echo ""
